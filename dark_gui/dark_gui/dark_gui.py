...
# Form implementation generated from reading ui file 'Jcc_timer2_dark.ui'
#
...
from event3 import Ui_event_wizard
...
"}")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(530, 290, 151, 531))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(430, 300, 81, 511))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(810, 370, 441, 371))
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(600, 860, 311, 101))
        self.pushButton_4.setObjectName("pushButton_4")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(90, 190, 1361, 51))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.entered_event_number = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        self.entered_event_number.setObjectName("entered_event_number")
        self.horizontalLayout.addWidget(self.entered_event_number)
        self.entered_age = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        self.entered_age.setObjectName("entered_age")
        self.horizontalLayout.addWidget(self.entered_age)
        self.entered_gender = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        self.entered_gender.setObjectName("entered_gender")
        self.horizontalLayout.addWidget(self.entered_gender)
        self.entered_distance = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        self.entered_distance.setObjectName("entered_distance")
        self.horizontalLayout.addWidget(self.entered_distance)
        self.entered_stroke = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        self.entered_stroke.setObjectName("entered_stroke")
        self.horizontalLayout.addWidget(self.entered_stroke)
        self.entered_number_of_heats = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        self.entered_number_of_heats.setObjectName("entered_number_of_heats")
        self.horizontalLayout.addWidget(self.entered_number_of_heats)
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(590, 60, 321, 33))
        self.label_9.setObjectName("label_9")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(100, 140, 1361, 41))
